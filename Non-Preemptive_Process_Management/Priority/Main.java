...
class Main extends Thread{
 ...
 System.out.println("\nDONE\nProcess \tArrival Time \tBurst Time \tPriority \tWait Time \tTurnaround Time"); 
  ...
  public static void print()
  {
    ...
    {
        System.out.println(q.get(i).name+"\t\t"+q.get(i).arrivalTime+"\t\t"+q.get(i).burstTime+"\t\t"+q.get(i).priority);
    }
  }
...
class NewProcess extends Thread
{
    ...
    public void run()
    {
        ...
        Main.list.add(new Process(Integer.toString(Main.count+1),Main.time,r.nextInt(10)+1,r.nextInt(5)+1));
        Main.count++;
